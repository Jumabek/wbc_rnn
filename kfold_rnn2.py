...
def lstm_cell():
    return rnn.BasicLSTMCell(num_hidden,forget_bias=1)
...
class Model:
    ...
    def _build_net(self):
        ...
        self.performance_summaries = tf.summary.merge([self.acc_summary,self.loss_summary])
...
for k in range(start_k,K):
    ...
    print("Optimization Finished for {}!".format(k))
    print("best test acc          :",best_acc)
    print('corresponding train acc:',corresponding_train_acc)
    print('==============================================')
    best_test_acc_sum+=best_acc
    writer.close()    
print("{}-Fold accuracry: {:.2f}\n".format(K,best_test_acc_sum/best_acc*100))
